...
export function WatchListSkeletonLoader() {
  return (
      ...
      <div className="w-full h-full mt-20 mb-[50px] space-y-[25px]">
        ...
        <div className='w-full h-full space-y-[25px]'>
          {Array.from({ length: 5 }).map((_, index) => (
            <div key={index} className='w-full bg-[#212121] rounded-[15px] p-[25px] grid grid-cols-5 gap-2'>
              ...
              {/* Delete BTN & Dropdown BTN Skeleton */}
              <div className='flex items-center justify-end gap-[12px]'>
                <Skeleton height={36} width={70} className="rounded-[10px]" />
